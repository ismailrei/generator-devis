...
var Unix_socket= require('./lib/Unix_socket')
...
module.exports = function main (options) {
  ...
  seneca.add({ role: internals.plugin, hook: 'listen', type: 'unix_socket' }, Unix_socket.listen(settings, transportUtil))
  seneca.add({ role: internals.plugin, hook: 'client', type: 'unix_socket' }, Unix_socket.client(settings, transportUtil))
